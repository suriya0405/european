...
import "../src/popupform.css";
import './css/capstyle.css';
import axios from 'axios';
import img from "./img/doctor student.jpg";
...
const PopupForm = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (name === "state") {
            ...
            setFormData({ ...formData, city: "", [name]: value });
        } else {
    ...
    return (
        <div className="main">
            <div className="popup">
                <div className="popup-header" style={{ backgroundColor: '', padding: '10px', color: 'white' }}>
                    <h2>Register For Free Counseling</h2>
                </div>
                        ...
                        <div className="form-content">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="dropdowns" >
                                    <div className="State" style={{ width: '225px', paddingRight: '10px' }} > <select
                                        name="state"
                                    ...
                                    <div className="City" style={{ width: '240px', color: 'white' }}  >
                                        <select
                                            name="city"
                                            value={formData.city}
                                            onChange={handleInputChange}
                    ...
                    <div className="discription">
                        <div className="checkbox-section">
                            <label className="checkbox-container">
                                <input type="checkbox" id="whatsapp" required />
                                Do you want us to send your brochures, fees structure, youtube - video links & complete information on your
                            ...
                            <p className="note">
                                <strong>Note:</strong> We don’t share your contact details; We respect your privacy.
                            </p>
                        </div>
